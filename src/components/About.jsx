    ...
    return (
        <div name="about" className='w-full h-screen bg-gradient-to-b from-gray-800 to-black text-white'>
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
                ...
                <p className='text-lg mt-20 text-center'>One of my first encounters with the IT fields was when I was barely 10 years old and got my first computer.
                ...
                <p className='text-lg mt-20 mb-20 text-center'>
